                            ...
                            <div class="card-group">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="view overlay">
                                        ...
                                        <img class="image" src="{{$provider_details->picture ?? asset('placeholder.png')}}">
                                        <a href="#!">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <a class="btn btn-primary button-width" href="{{ route('admin.providers.edit', ['provider_id' => $provider_details->id])}}">{{tr('edit')}}</a>

                                                        <a class="btn btn-danger button-width" href="{{route('admin.providers.delete', ['provider_id' => $provider_details->id])}}" onclick="return confirm(&quot;{{tr('provider_delete_confirmation' , $provider_details->name)}}&quot;);">{{tr('delete')}}</a> 
                                                        @if($provider_details->status == PROVIDER_APPROVED)

                                                            <a class="btn btn-danger button-width" href="{{ route('admin.providers.status', ['provider_id' => $provider_details->id]) }}" onclick="return confirm(&quot;{{$provider_details->first_name}} - {{tr('provider_decline_confirmation')}}&quot;);">
                                                                {{ tr('decline') }} 
                                                            </a> 
                                                        @else

                                                            <a class="btn btn-success button-width" href="{{ route('admin.providers.status', ['provider_id' => $provider_details->id]) }}">
                                                                {{ tr('approve') }} 
                                                            </a> 
                                                        @endif
                                        <div class="row">
