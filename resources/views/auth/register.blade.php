                    ...
                    <form action="{{ route('register') }}" method="POST" class="pt-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="first_name" class="form-control form-control-lg border-left-0" placeholder="{{ tr('first_name') }}" value="{{ old('first_name') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="last_name" class="form-control form-control-lg border-left-0" placeholder="{{ tr('last_name') }}" value="{{ old('last_name') }}" required>
